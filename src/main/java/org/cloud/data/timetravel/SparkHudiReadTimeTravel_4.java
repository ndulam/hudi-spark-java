...
public class SparkHudiReadTimeTravel_4 {
    public static void main(String[] args) {
        ...
        Dataset trips_df2 = spark.read().format("org.apache.hudi").load("file:///D:/sparksetup/sparkdata/trips_table_timetravel");
        trips_df2.createOrReplaceTempView("trips_table_timetravel2");
        spark.sql("SELECT *  FROM  trips_table_timetravel2").show();
    }
}
