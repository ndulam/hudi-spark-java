...
public class SparkHudiReadData_2 {
    public static void main(String[] args) {
        ...
        //Read table data
        Dataset trips_df = spark.read().format("org.apache.hudi").load("file:///D:/sparksetup/sparkdata/trips_table_timetravel");
        trips_df.createOrReplaceTempView("trips_table_timetravel");
        spark.sql("SELECT * FROM  trips_table_timetravel").show(false);
    }
}
