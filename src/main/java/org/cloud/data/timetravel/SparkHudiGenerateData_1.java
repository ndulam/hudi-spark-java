...
public class SparkHudiGenerateData_1 {
    public static void main(String[] args) {
        ...
        nums.add(RowFactory.create(1695516137021L,"e3cf430c-889d-4015-bc98-59bdce1e530c","rider-F","driver-P",37.15,"hyderabad" ));
        nums.add(RowFactory.create(1695516137021L,"e3cf430c-889d-4015-bc98-59bdce1e530c","rider-D","driver-T",44.15,"hyderabad" ));
        nums.add(RowFactory.create(1695115999925L,"c8abbe79-8d89-47ea-b4ce-4d224bae5bfa","rider-J","driver-T",17.85,"chennai"));

        Dataset<Row> dataset = spark.createDataFrame(nums, structType);
        dataset.write().format("org.apache.hudi").option(PARTITIONPATH_FIELD_NAME.key(),"city").option("hoodie.table.name","trips_table_timetravel")
                .option("hoodie.table.type",HoodieTableType.MERGE_ON_READ.name()).mode(SaveMode.Overwrite)
                .save("file:///D:/sparksetup/sparkdata/trips_table_timetravel");
