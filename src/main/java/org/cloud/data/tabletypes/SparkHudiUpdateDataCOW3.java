...
public class SparkHudiUpdateDataCOW3 {
    public static void main(String[] args) {
        ...
        Dataset trips_df = spark.read().format("org.apache.hudi")
                .load("file:///D:/sparksetup/sparkdata/trips_table_cow");
        ...
        trips_df_updates.write().format("org.apache.hudi").option("hoodie.datasource.write.operation","upsert")
                .option(PARTITIONPATH_FIELD_NAME.key(),"city").option("hoodie.table.name","trips_table_cow").mode(SaveMode.Append).save("file:///D:/sparksetup/sparkdata/trips_table_cow");
    }
}
