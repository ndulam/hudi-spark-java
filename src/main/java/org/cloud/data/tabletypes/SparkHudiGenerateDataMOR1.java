...
public class SparkHudiGenerateDataMOR1 {
    public static void main(String[] args) {
        ...
        dataset.write().format("org.apache.hudi").option(PARTITIONPATH_FIELD_NAME.key(),"city").option("hoodie.table.name","trips_table_mor")
                .option("hoodie.datasource.write.table.type",HoodieTableType.MERGE_ON_READ.name()).mode(SaveMode.Overwrite)
                .save("file:///D:/sparksetup/sparkdata/trips_table_mor");
