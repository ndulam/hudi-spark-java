...
public class SparkHudiReadData2 {
    public static void main(String[] args) {
        ...
        Dataset trips_df = spark.read().format("org.apache.hudi").load("file:///D:/sparksetup/sparkdata/trips_table_mor");
        ...
        spark.read().parquet("file:///D:/sparksetup/sparkdata/trips_table_mor/san_francisco/*.parquet").show(false);
    }
}
